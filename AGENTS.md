...
This file is the quick-reference operating contract for pkg-config-kotlin. The longer
...
pkg-config-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`pkg-config`](https://crates.io/crates/pkg-config). Upstream Rust is the behavioral oracle while the
